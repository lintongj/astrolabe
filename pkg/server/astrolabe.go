...
func NewProtectedEntityManager(confDirPath string, logger logrus.FieldLogger) astrolabe.ProtectedEntityManager {
	dpem := NewDirectProtectedEntityManagerFromConfigDir(confDirPath, logger)
